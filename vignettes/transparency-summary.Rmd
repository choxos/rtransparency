...
**Registration is summarized over research articles.** When the data carry
`is_research` (as `rt_all_pmc()` output does), the registration denominator is
restricted to research articles, as in Serghiou et al. (2021); set
`register_research_only = FALSE` to count every article.
