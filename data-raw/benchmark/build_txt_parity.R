...
md <- c(
  ...
  paste0("Package version ", utils::packageVersion("rtransparency"), ". Derived from ",
         ...
         "PMC column for those rows: several articles whose plain text carries a ",
         "conflict-of-interest heading and statement (\"Declaration of competing ",
         "interest: None.\") are labeled FALSE, which lowers the TXT COI ",
         "specificity shown here."),
  "",
